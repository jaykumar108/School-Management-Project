...
const SubadminListData = ({ subadmins, onEdit, onDelete }) => {
  return (
                    ...
                    <div className="flex-shrink-0 h-10 w-10">
                      <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                        <span className="text-blue-600 font-medium">
                          {subadmin.name.split(' ').map(n => n[0]).join('')}
                        </span>
                      </div>
                    </div>
                    <div className="ml-4">
                      <div className="text-sm font-medium text-gray-900">{subadmin.name}</div>
                      <div className="text-sm text-gray-500">ID: {subadmin.subadminId}</div>
                    </div>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
...
export default SubadminListData; 